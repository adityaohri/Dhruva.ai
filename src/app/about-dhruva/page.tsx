...
export default async function AboutDhruvaPage() {
          ...
          <div className="mx-auto flex max-w-5xl flex-col gap-10">
            ...
            <div className="space-y-8">
              <p className="max-w-3xl text-sm sm:text-base text-[rgba(60,42,106,0.75)]">
                The career-anxious Indian student or graduate, aged 19–27 —
                talented and motivated, yet disadvantaged by a market that
                rewards navigation over merit.
              </p>
          ...
          <div className="mx-auto flex max-w-5xl flex-col gap-10">
            <header className="space-y-2 text-left">
              ...
              <p className="max-w-2xl text-sm sm:text-base text-[rgba(60,42,106,0.75)]">
                Not three tools stitched together. A single data-driven workflow
                where each engine feeds the next.
              </p>
            </header>
              ...
              {[
                ...
                >
                  ...
                  <div className="platform-card-content space-y-3 text-left">
                    ...
                    <p className="text-sm text-slate-200">{block.body}</p>
                  </div>
                </div>
              ))}
            </div>
